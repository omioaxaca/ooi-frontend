      ...
      {guides.map((guide) => (
        <li key={guide.documentId} className="min-w-0 space-y-2 py-4">
          <Link
            ...
            className="flex items-start gap-2 font-medium text-ooi-second-blue hover:underline"
          >
      ...
      {problems.map((problem) => {
        ...
        return (
          <li
            ...
            className="flex flex-col items-start gap-3 py-4 sm:flex-row sm:justify-between"
          >
            <div className="min-w-0 space-y-2">
              <Link
                href={problemHref(problem, topic)}
                className="font-medium text-ooi-second-blue hover:underline break-words"
              >
                {problem.title}
              </Link>
