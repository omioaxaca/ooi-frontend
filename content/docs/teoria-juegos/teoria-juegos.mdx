---
title: "Teorema de Sprague-Grundy"
description: "Combina juegos imparciales independientes mediante XOR y comprueba las condiciones del teorema."
date: "2026-02-09"
author: "OOI Oaxaca"
...
Aquí estudiamos juegos por turnos, sin azar y con información completa. Sprague-Grundy se aplica al caso **imparcial y de regla normal** que siempre termina: ambos jugadores tienen los mismos movimientos disponibles desde una posición, y pierde quien no puede mover. No se aplica directamente a cualquier juego, a juegos con empates o a reglas misère.
...
6. Los movimientos legales desde una posición no dependen de la identidad del jugador
...
Estrategia: quitar 2 de la pila de 3 → pilas: 1, 4, 5
XOR: 1 ^ 4 ^ 5 = 001 ^ 100 ^ 101 = 000 = 0 ✓
```

## Sprague-Grundy

El teorema de Sprague-Grundy relaciona los juegos imparciales finitos de regla normal con Nim. Cada posición tiene un **valor de Grundy** (nimber):
...
La recursión directa anterior repite estados y puede ser exponencial; sirve para trazar ejemplos pequeños. La tabla de DP de abajo, o la guía de [Grundy](/blog/teoria-juegos/grundy), evita esas repeticiones.
...
La independencia exige que un movimiento modifique **exactamente un componente**, sin cambiar las opciones de los demás. Si una jugada modifica dos pilas, compartir recursos limita las otras jugadas o el turno depende del componente elegido, no puedes aplicar XOR sin una nueva justificación.

Para entender la prueba, recuerda que ningún sucesor tiene el mismo Grundy que su estado, y que todos los valores menores que su Grundy sí aparecen entre los sucesores. Desde XOR cero, cambiar un único nimber deja XOR no cero. Desde XOR no cero, el argumento del bit más alto de Nim encuentra un componente cuyo nimber puede reducirse a un valor menor para dejar XOR cero; la propiedad de mex garantiza que ese movimiento existe.
...
<Callout type="info">
  Calcular valores pequeños ayuda a proponer un patrón, pero no demuestra que
  continúe. Justifica cualquier fórmula mediante las reglas de transición o una
  prueba de periodicidad antes de usarla para tamaños grandes.
</Callout>
